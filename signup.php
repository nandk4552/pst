...
<body class="text-center">
    ...
    <div class="container d-flex align-items-center justify-content-center my-5">
        ...
        <form class="form-floating" action="<?php echo SITEURL; ?>login.php" method="post">
            <h1 class="display-4 text-dark font-weight-700">Hackathon</h1>
            ...
            <div>
                <a href="<?php echo SITEURL; ?>login.php" class="my-3">if you already have account?</a>
            </div>
            <button class="w-100 btn btn-lg btn-secondary" type="submit" name="submit">Signup</button>
            <div>
            </div>
            <p class="mt-5 mb-3 text-muted">© <?php echo date("Y"); ?> - <?php echo date("Y") + 4; ?> </p>
        </form>
